...
# call each function to get the names, titles and array of defaults set to -1
  ...
  pagename = 'Timing2'
  names = ['timing2']    # This will be the overall status graph name for this module, must start with modulename_
  titles = ['Timing2 status']   # This will be the status graph title
...
def sc_rf_time(rootfile) :
  ...
  names = ['timing2_sc_rf_status', 'pim_SCRFdt_mg', 'pim_SCRFdt_mg_err', 'pip_SCRFdt_mg', 'pip_SCRFdt_mg_err', 'proton_SCRFdt_mg', 'proton_SCRFdt_mg_err']   
...
def tof_rf_time(rootfile) :
  ...
  names = ['timing2_tof_rf_status', 'pim_TOFRFdt_mg', 'pim_TOFRFdt_mg_err', 'pip_TOFRFdt_mg', 'pip_TOFRFdt_mg_err', 'proton_TOFRFdt_mg', 'proton_TOFRFdt_mg_err']   
...
def bcal_rf_time(rootfile) :
  ...
  names = ['timing2_bcal_rf_piplus_status', 'pim_BCALRFdt_mg', 'pim_BCALRFdt_mg_err', 'pip_BCALRFdt_mg', 'pip_BCALRFdt_mg_err', 'proton_BCALRFdt_mg', 'proton_BCALRFdt_mg_err', 'gamma_BCALRFdt_mg', 'gamma_BCALRFdt_mg_err', 'gamma_1GeV_BCALRFdt_mg', 'gamma_1GeV_BCALRFdt_mg_err']   
...
def fcal_rf_time(rootfile) :
  ...
  names = ['timing2_fcal_rf_piplus_status', 'pim_FCALRFdt_mg', 'pim_FCALRFdt_mg_err', 'pip_FCALRFdt_mg', 'pip_FCALRFdt_mg_err', 'gamma_FCALRFdt_mg', 'gamma_FCALRFdt_mg_err']   
